...
##1 x détecteur de mouvement infrarouge PIR
...
<img src="/images/jumper-male-to-male.png"  width="20%" heigth ="20%"/></a>
...
## Gagnez du temps     
S'il vous manque plusieurs des élements ci-dessus, nous vous conseillons notre [kit clés en main complet](https://www.amazon.fr/dp/B01N0TKCJN). Il vous coûtera moins cher que les pièces commandées individuellement, il vous évitera d'acheter un lors de 200 LED alors que vous n'en voulez que 2, et sera livrable demain chez vous. Celui-ci contient tout le nécessaire pour réaliser ce tutorial, et même des pièces complémentaires pour réaliser des projets plus complexes. 
